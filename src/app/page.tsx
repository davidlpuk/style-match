    ...
    <main className="min-h-screen flex flex-col text-white font-sans">
      ...
      <div className="flex-1 flex flex-col items-center justify-center px-4 py-12 md:py-20">
        <div className="text-center max-w-md w-full space-y-6">
          {/* App Icon/Logo */}
          <div className="w-20 h-20 mx-auto bg-gradient-to-br from-pink-500 to-purple-600 rounded-3xl flex items-center justify-center shadow-2xl mb-4" role="img" aria-label="Style Match application logo">
      ...
      <div className="px-4 pb-12 max-w-md mx-auto w-full space-y-4">
        {/* Feature Card 1 */}
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 hover:bg-white/15 transition-all duration-300 border border-white/10" role="article" aria-labelledby="feature-1-title">
        ...
        {/* Feature Card 2 */}
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 hover:bg-white/15 transition-all duration-300 border border-white/10" role="article" aria-labelledby="feature-2-title">
          <div className="flex items-start space-x-4">
            <div className="text-3xl" aria-hidden="true">💕</div>
            <div className="flex-1">
        ...
        {/* Feature Card 3 */}
        <div className="bg-white/10 backdrop-blur-lg rounded-3xl p-6 hover:bg-white/15 transition-all duration-300 border border-white/10" role="article" aria-labelledby="feature-3-title">
          <div className="flex items-start space-x-4">
            <div className="text-3xl" aria-hidden="true">✨</div>
            <div className="flex-1">
